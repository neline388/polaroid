  ...
  return (
    <section id="services" className="page-section">
      ...
      <div className="background-images">
        ...
        <img src="/polaroid/images/2.png" className="bg-img img-2" alt="img2" />
        <img src="/polaroid/images/1.png" className="bg-img img-1" alt="img1" />
        <img src="/polaroid/images/4.png" className="bg-img img-4" alt="img4" />
        <img src="/polaroid/images/5.png" className="bg-img img-5" alt="img5" />
      </div>
